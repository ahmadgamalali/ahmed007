(function(){
  ...
  if (headerTarget) {
    headerTarget.innerHTML = `<header class="site-shell-header"><div class="inner"><div class="site-top"><a class="site-brand" href="/index.html"><i class="fas fa-shield-halved"></i><span>أحمد أبو المجد</span></a><nav class="site-links">${links}</nav></div></div></header>`;
  }
