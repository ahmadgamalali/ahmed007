...
<body>
    ...
    <script>
        const sectionKey = 'adminMenuCollapsedState';
        const sections = Array.from(document.querySelectorAll('[data-section]'));

        function saveState() {
            const state = sections.map((section) => section.classList.contains('collapsed'));
            localStorage.setItem(sectionKey, JSON.stringify(state));
        }

        function setExpandedState(button, isCollapsed) {
        ...
        if (storedState) {
            ...
            if (activeItem) {
                ...
                sections.forEach((section) => {
                    const shouldCollapse = section !== parentSection;
                    section.classList.toggle('collapsed', shouldCollapse);
                });
            }
        }
        ...
        sections.forEach((section) => {
            ...
            if (!btn) return;
            setExpandedState(btn, section.classList.contains('collapsed'));
